...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ejii5tu.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ejii5tu.containers.anotherwebservice.com/
...
```
git clone git@github.com:arjunlubana/container-ejii5tu.git
cd container-ejii5tu
```
...
```
docker attach container-ejii5tu
```
